...
Objetivo: Organizar multiplos projetos ou pacotes em um unico repositorio de forma sustentavel, com builds eficientes e limites claros entre componentes.
...
Faz sentido quando:
- Codigo compartilhado entre multiplos servicos ou apps (UI components, utils, tipos)
- Mudancas frequentes que afetam multiplos pacotes ao mesmo tempo
- Time pequeno-medio (2-15 devs) trabalhando em componentes relacionados
- Quer consistencia de tooling (linting, testing, build) entre projetos

Multi-repo e melhor quando:
- Projetos independentes com ciclos de release separados
- Times autonomos que nao compartilham codigo
- Linguagens/stacks completamente diferentes
- Repositorio ficaria grande demais (> 5GB, milhares de pacotes)
