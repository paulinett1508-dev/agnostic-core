# Tabela de Responsividade por Componente
...
## Por que tabela por componente (não por breakpoint)

Abordagem comum (problemática):
> "Em mobile, tudo vai para coluna única."

Abordagem por componente:
> Cada componente tem regras explícitas para cada viewport.

O segundo elimina ambiguidade e serve como spec para implementação e revisão.
