...
[technical-docs]
- keywords: documentacao tecnica, readme, adr, architecture decision record, jsdoc, changelog, keep a changelog, documentar projeto, escrever readme, decisao arquitetural, documentacao de codigo, docs do projeto
- path: skills/documentation/technical-docs.md
- tipo: tecnica
- descricao: README, ADR, JSDoc e CHANGELOG (Keep a Changelog)

[openapi-swagger]
- keywords: openapi, swagger, api spec, especificacao de api, yaml de api, api documentation, openapi 3.1, schema de api, documentar api, swagger ui, api contract, api spec file
